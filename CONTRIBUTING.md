...
Prod branch is main and should be treated as such. Dev branch is dev. Every feature bust be a separate branch, originating from dev. Once a feature is ready, it can be merged to dev, and if all is ok, then it will be merged to main.
Branch names
